...
:global([data-sonner-toast][data-theme='dark']) :global([data-cancel]) {
...
:global([data-sonner-toast]:after) {
	content: '';
	position: absolute;
	left: 0;
...
:global([data-sonner-toast][data-expanded='false'][data-front='false'][data-styled='true']) > :global(*) {
	opacity: 0;
}
...
:global([data-sonner-toaster][data-theme='light']) :global([data-sonner-toast][data-invert='true']) {
	--normal-bg: #000;
	--normal-border: hsl(0, 0%, 20%);
	--normal-text: var(--gray1);
}

:global([data-sonner-toaster][data-theme='dark']) :global([data-sonner-toast][data-invert='true']) {
	--normal-bg: #fff;
...
:global([data-rich-colors='true']) :global([data-sonner-toast][data-type='success']) :global([data-close-button]) {
	background: var(--success-bg);
	border-color: var(--success-border);
	color: var(--success-text);
}
...
:global([data-rich-colors='true']) :global([data-sonner-toast][data-type='info']) :global([data-close-button]) {
	background: var(--info-bg);
	border-color: var(--info-border);
	color: var(--info-text);
}
...
:global([data-rich-colors='true']) :global([data-sonner-toast][data-type='warning']) :global([data-close-button]) {
	background: var(--warning-bg);
	border-color: var(--warning-border);
	color: var(--warning-text);
}
...
:global([data-rich-colors='true']) :global([data-sonner-toast][data-type='error']) :global([data-close-button]) {
	background: var(--error-bg);
	border-color: var(--error-border);
	color: var(--error-text);
}
